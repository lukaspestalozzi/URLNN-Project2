...
class SarsaAgent():
    def __init__(self,warm_start=None):
        ...
        self.NN = nn.MountainCarNeuronalNetwork(warm_start=warm_start, nbr_neuron_rows=20, nbr_neuron_cols=20, init_weight=0.0)
    ...
    def train(self, n_steps=None, n_episodes=None):
        ...
        return self.NN.train(n_steps=7000 if n_steps is None else n_steps,
                             n_episodes=epis,
                             reward_factor=0.95,
